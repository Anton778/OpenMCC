...
Широкая полоса **203 кГц** выбрана намеренно: на стенде некоторые модули имели заметный частотный уход относительно 435.000 МГц. Этот набор значений используется как исходный профиль при включении ESP32. В панели команд можно изменить частоту, мощность TX и полосу RX, а кнопка **«Сбросить к исходным»** возвращает `435.000 МГц`, `5 дБм` и `203 кГц`.

Доступные настройки CC1101:

- частота наземного модуля: от `387.000` до `464.000 МГц`;
- мощность TX: `−30`, `−20`, `−15`, `−10`, `0`, `5`, `7` или `10 дБм`;
- полоса RX: `58`, `68`, `81`, `102`, `116`, `135`, `162`, `203`, `232`, `270`, `325`, `406`, `464`, `541`, `650` или `812 кГц`.
