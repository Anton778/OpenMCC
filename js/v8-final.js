...
(() => {
    ...
    function cleanLegacyUi() {
        ...
        if (help) {
            ...
            if (sections[2]) {
                sections[2].innerHTML = '<h3>Радиоканал</h3><p>Наземный CC1101 работает на <strong>435.000 МГц</strong>: 4.8 kbps, 2-FSK, девиация 5 кГц, RX BW 203 кГц. Аппаратный CRC CC1101 включён. Шлюз поддерживает передачу команд с ЦУПа.</p>';
            }
        }
    }
