...
/*
 * ЦУП Альтаир v8 — наземный радиошлюз Arduino Uno + CC1101.
 *
 * Подключение CC1101:
 *   CSN  -> D10
 *   MOSI -> D11
 ...
 *   GND  -> GND
 *
 * ВАЖНО: ATmega328P работает с логическими уровнями 5 В, а CC1101 —
 * с уровнями 3,3 В. Линии SCK, MOSI и CSN необходимо подключать через
 ...
 * оперативную память Arduino Uno.
 */
...
static const char BOARD_NAME[] = "ARDUINO_UNO";
